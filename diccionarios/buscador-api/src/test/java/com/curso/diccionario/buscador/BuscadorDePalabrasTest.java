...
class BuscadorDePalabrasTest {
    ...
    @Autowired
    BuscadorDePalabrasTest(BuscadorDePalabras miBuscadorDePalabras ){ // Solicito la dependencia (inyección de dependencias)
    ...
    void crearIdiomaEnBBDD(){
        ...
        when(miRepositorioIdiomas.findByNombre(IDIOMA_EXISTENTE))
                .thenReturn(Optional.of(idiomaExistente));
